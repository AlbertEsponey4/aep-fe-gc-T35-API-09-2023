...
namespace piezas.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ProveedoresController : ControllerBase
    {
        private readonly piezasContext _context;

        public ProveedoresController(piezasContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Proveedore>> PostProveedore(Proveedore proveedore)
        {
          if (_context.Proveedores == null)
          {
              return Problem("Entity set 'piezasContext.Proveedores'  is null.");
          }
            ...
            {
                if (ProveedoreExists(proveedore.Codigo))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetProveedore", new { id = proveedore.Codigo }, proveedore);
        }
